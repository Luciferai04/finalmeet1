...
from vad_fixed import VoiceActivityDetector
from backend.base import ServeClientBase
...
class TranscriptionServer:
    ...
    def initialize_client(
        ...
        if self.backend.is_tensorrt():
            try:
                from backend.trt_backend import ServeClientTensorRT
        ...
        if self.backend.is_openvino():
            try:
                from backend.openvino_backend import ServeClientOpenVINO
        ...
        try:
            if self.backend.is_faster_whisper():
                from backend.faster_whisper_backend import ServeClientFasterWhisper
